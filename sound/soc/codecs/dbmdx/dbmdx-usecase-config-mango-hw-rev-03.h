...
#define NONE_OPTIMIZED_TL_FREQ_VA_VE_CORE_MANGO	315000000
...
static struct usecase_config config_uc_mango_idle = {
	...
	.clock_op_va_ve = DBMDX_CLOCK_OP_CONFIG_IF_MASTER_CLOCK_HIGHER,
	.clock_config_va = {
			.wanted_pll = 0,
	...
	.clock_config_va_ve = {
			.wanted_pll = 0,
			.wanted_tl3_clk = 294000000,
			.wanted_ahb_clk = 294000000/2,
			.wanted_apb_clk = 0,
			.use_pll_post_div = false,
			.threshold_value = 12,
		},
...
#endif
#if defined(DBMDX_I2S_STREAMING_SUPPORTED) && defined(VA_VE_I2S_MASTER)
	.clock_op_va_i2s_master = DBMDX_CLOCK_OP_SWITCH_TO_TDM_CLOCK,
#else
	.clock_op_va_i2s_master = DBMDX_CLOCK_OP_DO_NOT_CONFIG,
#endif
	.clock_op_va_ve = DBMDX_CLOCK_OP_DO_NOT_CONFIG,
#ifdef DBMDX_MANGO_SRATE_16000
	.tdm_clock_freq = TDM_CLK_FREQ_16,
...
static struct usecase_config config_uc_mango_barge_in_48k_16b_32b_hw_rev_03 = {
	...
	.va_cfg_values = (u32 []){
		...
		(DBMDX_REGN_AUDIO_STREAMING_SRC_SELECT |
			...
			defined(DBMDX_MANGO_BARGEIN_GA_MODE)
			DBMDX_REGV_NO_STREAM_CH_1),
#else
			DBMDX_REGV_STREAM_CH_1_CP_4),
#endif
	...
	.va_ve_cfg_values = (u32 []){
		...
		(DBMDX_UC_SEQ_CMD_USLEEP | 0x2710),
		(DBMDX_REGN_ASRP_OUTPUT_ROUTING |
#ifdef DBMDX_MANGO_BARGEIN_GA_MODE
...
/* Mango Barge In usecase 48Khz 16 Bit or 16 from 32 Bit*/
static struct usecase_config config_uc_mango_production_mic1_hw_rev_03 = {
#ifdef AEC_REF_32_TO_16_BIT
	.usecase_name = "uc_mango_production_mic1",
#else
	.usecase_name = "uc_mango_production_mic1",
#endif
...
#endif
#endif
		(DBMDX_REGN_ASRP_IN_TO_OUT_IN_BYPASS_MODE|0x01),
		(DBMDX_UC_SEQ_CMD_CONFIG_TDM |
			DBMDX_UC_SEQ_CMD_VAL_TDM0_VA_VE_RX),
		(DBMDX_UC_SEQ_CMD_CONFIG_TDM |
			DBMDX_UC_SEQ_CMD_VAL_TDM0_VA_VE_TX),
...
/* Mango Barge In usecase 48Khz 16 Bit or 16 from 32 Bit*/
static struct usecase_config config_uc_mango_production_mic2_hw_rev_03 = {
#ifdef AEC_REF_32_TO_16_BIT
	.usecase_name = "uc_mango_production_mic2",
#else
	.usecase_name = "uc_mango_production_mic2",
#endif
...
#endif
#endif
		(DBMDX_REGN_ASRP_IN_TO_OUT_IN_BYPASS_MODE|0x02),
		(DBMDX_UC_SEQ_CMD_CONFIG_TDM |
			DBMDX_UC_SEQ_CMD_VAL_TDM0_VA_VE_RX),
		(DBMDX_UC_SEQ_CMD_CONFIG_TDM |
			DBMDX_UC_SEQ_CMD_VAL_TDM0_VA_VE_TX),
...
/* Mango Barge In usecase 48Khz 16 Bit or 16 from 32 Bit*/
static struct usecase_config config_uc_mango_production_mic3_hw_rev_03 = {
#ifdef AEC_REF_32_TO_16_BIT
	.usecase_name = "uc_mango_production_mic3",
#else
	.usecase_name = "uc_mango_production_mic3",
#endif
...
#endif
#endif
		(DBMDX_REGN_ASRP_IN_TO_OUT_IN_BYPASS_MODE|0x03),
		(DBMDX_UC_SEQ_CMD_CONFIG_TDM |
			DBMDX_UC_SEQ_CMD_VAL_TDM0_VA_VE_RX),
		(DBMDX_UC_SEQ_CMD_CONFIG_TDM |
			DBMDX_UC_SEQ_CMD_VAL_TDM0_VA_VE_TX),
...
/* Mango Barge In usecase 48Khz 16 Bit or 16 from 32 Bit*/
static struct usecase_config config_uc_mango_production_ref1_hw_rev_03 = {
#ifdef AEC_REF_32_TO_16_BIT
	.usecase_name = "uc_mango_production_ref1",
#else
	.usecase_name = "uc_mango_production_ref1",
#endif
...
#endif
#endif
		(DBMDX_REGN_ASRP_IN_TO_OUT_IN_BYPASS_MODE|0x04),
		(DBMDX_REGN_ASRP_OUTPUT_GAIN_DEST_VALUE|0x011f),
		(DBMDX_UC_SEQ_CMD_CONFIG_TDM |
			DBMDX_UC_SEQ_CMD_VAL_TDM0_VA_VE_RX),
		(DBMDX_UC_SEQ_CMD_CONFIG_TDM |
			DBMDX_UC_SEQ_CMD_VAL_TDM0_VA_VE_TX),
...
/* Mango Barge In usecase 48Khz 16 Bit or 16 from 32 Bit*/
static struct usecase_config config_uc_mango_production_ref2_hw_rev_03 = {
#ifdef AEC_REF_32_TO_16_BIT
	.usecase_name = "uc_mango_production_ref2",
#else
	.usecase_name = "uc_mango_production_ref2",
#endif
...
#endif
#endif
		(DBMDX_REGN_ASRP_IN_TO_OUT_IN_BYPASS_MODE|0x05),
		(DBMDX_REGN_ASRP_OUTPUT_GAIN_DEST_VALUE|0x011f),
		(DBMDX_UC_SEQ_CMD_CONFIG_TDM |
			DBMDX_UC_SEQ_CMD_VAL_TDM0_VA_VE_RX),
		(DBMDX_UC_SEQ_CMD_CONFIG_TDM |
