...
static int sdcardfs_statfs(struct dentry *dentry, struct kstatfs *buf)
{
	...
	///FW:20201207 remove for limit write to data partition, fix for cts
	/*
	original codes
	u32 min_blocks;
...
#if 0  /* FW: 20201207 remove for limit write to data partition, fix for cts */
...
#endif /* FW: 20201207 remove for limit write to data partition, fix for cts */
