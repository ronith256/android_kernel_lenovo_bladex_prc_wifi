...
#define FILTER_POINT                    50
#define TV_CONNECTING                    1
#define TV_CONNECTED                     2
#define TV_COODS_DOWN_X_MIN		945
#define TV_COODS_DOWN_X_MAX		1030
#define TV_COODS_UP_X_MIN		1120
#define TV_COODS_UP_X_MAX		1210
#define TV_COODS_Y		        1295
extern struct drm_panel *goodix_panel;
...
struct tv_report {
	struct goodix_ts_core *tv_core_data;
	struct mutex tv_mutex;
	int suspend_status;
	int resume_status;
	int hdmi_status;
	int suspend_by_hdmi;
	int pm_suspend_by_hdmi;
	int complete;
	unsigned int first_report;
	int brightness_plug_in;
	struct timespec64 start;
	struct timespec64 end;
};
extern struct tv_report tv_touchpoint;
/*
...
extern struct gesture_module *gsx_gesture;
